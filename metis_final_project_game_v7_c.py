...
def changeGame(policeState):
    ...
    trail, path, new_q_matrix = breadcrumb(policeState, q_matrix, row_max, col_max, num_rows, num_cols, posState, negState)
...
def playGame(expandedPath, expandedAngle, policeState):
    ...
    carFootPath = pygame.transform.scale(carFootPath, (10,10))
    ...
    def game_loop(expandedPath, expandedAngle, policeState):
        ...
        while not gameExit:
            ...
            if pressed[pygame.K_UP] and (policeState[0]*100>= 100):
                ...
                policeCarAngle = 90
                _, _, expandedPath, _, expandedAngle, _ = changeGame(policeState)
                counter = 0
                #footPathList = []
...
if __name__ == '__main__':
    ...
    policeState = (6,0)
    game_path, trail, expandedGamePath, angleList, expandedAngle, updatedMoveMatrix = changeGame(policeState)
